...
class CAM16(object):
    ...
    def __init__(self, c, Y_b, L_A, exact_inversion=True, whitepoint=whitepoints_cie1931["D65"]):
        ...
        RGB_aw_ = numpy.array([400.1 if a == numpy.inf else 400 * a / (a + 27.13) + 0.1 for a in alpha])
        ...
        self.invM_ = numpy.linalg.inv(self.M_) if exact_inversion else approx_inv_M16 / self.D_RGB
        return
